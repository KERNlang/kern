<div align="center">
  ...
  **Built for humans and AI.** 192-line spec. 13 compile targets. 182 review rules.<br>
...
kern review src/ --recursive                                  # Static analysis (182 rules, taint tracking)
...
Write `.kern` once, compile to 13 targets. Or skip `.kern` entirely and use `kern review` to scan your existing TypeScript and Python for security bugs, unguarded effects, and prompt injection — 182 AST-based rules that catch what ESLint misses.
...
**182 rules** across base, security, framework, performance, null-safety, dead-logic, concept, and taint-aware analysis layers.
