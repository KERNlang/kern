<div align="center">
  ...
  **Built for humans and AI.** 192-line spec. 13 compile targets. 178 review rules.<br>
...
kern review src/ --recursive                                  # Static analysis (178 rules, taint tracking)
...
Write `.kern` once, compile to 13 targets. Or skip `.kern` entirely and use `kern review` to scan your existing TypeScript and Python for security bugs, unguarded effects, and prompt injection — 178 AST-based rules that catch what ESLint misses.
...
**178 rules** across base, security, framework, performance, null-safety, dead-logic, concept, and taint-aware analysis layers.
