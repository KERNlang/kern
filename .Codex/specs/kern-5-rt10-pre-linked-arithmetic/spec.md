...
decimal-digit bound proves they fit. A configured cap of 0 bypasses the lock unless another KERN
window is active. Unknown conversion shapes take the locked path. The shared lock serializes large
