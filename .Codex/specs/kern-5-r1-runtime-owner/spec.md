...
| Owner identity | Stable marker `kern.runtime.kir.owner.v1` and format `kern.runtime.kir.v1` | RT-1 contract decision; changing either requires a new versioned value | DECIDED |
