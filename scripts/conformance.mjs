...
const FIXTURES = [
  ...
  // Direct route keyed-reshape parity. These intentionally skip the pure-pipeline
  // mirror until the pure-handler keyed reshape slice lands; the pure emitter now
  // throws loudly instead of silently dropping these nodes.
