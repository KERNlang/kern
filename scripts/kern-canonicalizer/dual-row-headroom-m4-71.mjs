...
const PUBLISHED_DIGEST = '8be340082e3a5de479b015d4f0f4248486286290ed981cbf5715538069638c12';
const SOURCE_COMMIT = '75a927c4faf36d4c18530ff30b4f877fdc411628';
...
function publishedHandoff(value) {
  ...
  if (digest !== PUBLISHED_DIGEST) fail('receipt must match the exact published M4.71 evidence');
  return { digest, record: structuredClone(value), sourceCommit: SOURCE_COMMIT };
}

export function validatePublishedCanonicalizerDualRowHeadroomM471(value) {
  return publishedHandoff(value);
}

export function loadPublishedCanonicalizerDualRowHeadroomM471() {
