...
const PUBLISHED_DIGEST = '67ed659c709adfc5cd51095a3ac5f9549b0384d9651ac3d74894ad4b3aab3402';
const SOURCE_COMMIT = '77ba01b467b411def9343ffb3c064e1650e6fced';
const SUMMARY_URL = new URL('./coverage-residual-analysis-m4-46.json', import.meta.url);
...
function publishedHandoff(value) {
  ...
  if (digest !== PUBLISHED_DIGEST) fail('receipt must match the exact published M4.46 analysis');
  return { digest, record: structuredClone(value), sourceCommit: SOURCE_COMMIT };
}

export function validatePublishedCanonicalizerResidualAnalysisM446(value) {
  return publishedHandoff(value);
}

export function loadPublishedCanonicalizerResidualAnalysisM446() {
