...
const EXPECTED_PARAMETER_MIGRATION = m4113ParameterMigration();
...
test('M4.113 consumes the depth-enabled queue and preserves bounded exhaustion', () => {
...
test('M4.117 publishes the exact current post-migration frontier', () => {
  const actual = measureCanonicalizerPrerequisite();
  assert.equal(actual.format, 'kern.kir-canonicalizer.prerequisite-summary.3');
  assert.deepEqual(actual.baseline, {
    ...
    functionCount: 112,
    functionFactsDigest: '809a49daa3ce7a8ebd3f1cf16b3641ec12ac70a023e6e4cae1c29d4f5bd9729f',
