...
const EXPECTED_PARAMETER_MIGRATION = m4118ParameterMigration();
...
test('M4.118 publishes the promoted-profile queue and preserves bounded exhaustion', () => {
...
test('M4.118 publishes the exact current promoted-profile frontier', () => {
  const actual = measureCanonicalizerPrerequisite();
  assert.equal(actual.format, 'kern.kir-canonicalizer.prerequisite-summary.3');
  assert.deepEqual(actual.baseline, {
    ...
    corpusDigest: '5d4f1db7fe7c2cfcad970068270ae39a222e264d02105e6e83ccdcd00c55808a',
    coverageImplementationDigest: actual.baseline.coverageImplementationDigest,
    coveragePolicyDigest: '62518079fabc880efaaf2da72d7904b0cb4d5b834f375f3fd4d78be28b20af94',
    familyRegistryDigest: 'a7ea4bdc1af766f893b7491a59c727b0459ecb637a71f9f54d6087ee5baeeb87',
    functionCount: 112,
    functionFactsDigest: '974c1a570cd45f868cf98469fc066cd70bb32441380bb38586a33a4735079cbb',
