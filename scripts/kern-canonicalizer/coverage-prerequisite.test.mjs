...
const EXPECTED_EXHAUSTION = {
  ...
  reasonAssignmentsDigest: 'd56df2cc197c26f4c6f302c32e6447828e1e7359ba6f525f82bda5b6e2b5c481',
  reasonCounts: [
    ...
    { count: 1, id: 'projection.limit-depth' },
...
test('M4.124 publishes the exact current post-migration frontier', () => {
  ...
  assert.deepEqual(actual.baseline, {
    ...
    functionCount: 112,
    functionFactsDigest: '4c501e27c37b964a426b0e36e77f838c0d15833868d0b74a9eb74d28c5d8d14d',
