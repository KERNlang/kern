...
const PUBLISHED_DIGEST = '8bc1be3c941c8fd2d8a4a5990de0266f54ae986fbfd1e4712e6044c78cc092cd';
const SOURCE_COMMIT = '953811cb5fdc5d13c92ada4e7f894eb9ac5cf0dc';
const SUMMARY_URL = new URL('./coverage-residual-analysis-m4-38.json', import.meta.url);
...
function publishedHandoff(value) {
  ...
  if (digest !== PUBLISHED_DIGEST) fail('receipt must match the exact published M4.38 analysis');
  return { digest, record: structuredClone(value), sourceCommit: SOURCE_COMMIT };
}

export function validatePublishedCanonicalizerResidualAnalysisM438(value) {
  return publishedHandoff(value);
}

export function loadPublishedCanonicalizerResidualAnalysisM438() {
