...
// The independent tests and coverage checker repeat these anchors so changing
// this loader alone cannot rewrite the published milestone.
const PUBLISHED_DIGEST = '110260eb3a2c9ed942e309d5b6e1331f2752bc486bfe99840c887e2a6ef7e7c3';
const SOURCE_COMMIT = '6aba5e056c833e7dd2e613a21ac52e3f718d9673';
...
function canonicalBytes(value) {
  // Property order is part of the immutable receipt byte contract.
...
function publishedHandoff(value) {
  ...
  if (digest !== PUBLISHED_DIGEST) fail('receipt must match the exact published M4.63 evidence');
  return { digest, record: structuredClone(value), sourceCommit: SOURCE_COMMIT };
}

export function validatePublishedCanonicalizerNodeRowHeadroomM463(value) {
  return publishedHandoff(value);
}

export function loadPublishedCanonicalizerNodeRowHeadroomM463() {
