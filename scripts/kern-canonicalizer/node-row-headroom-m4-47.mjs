...
const PUBLISHED_DIGEST = '0da8ef5be1be0ea2ac12ef739bd6cc38070d60b7b3a775f45602857d40979af1';
const SOURCE_COMMIT = '233e71a84fe7afdd7566e19a5545a885ffc36e8f';
...
function publishedHandoff(value) {
  ...
  if (digest !== PUBLISHED_DIGEST) fail('receipt must match the exact published M4.47 evidence');
  return { digest, record: structuredClone(value), sourceCommit: SOURCE_COMMIT };
}

export function validatePublishedCanonicalizerNodeRowHeadroomM447(value) {
  return publishedHandoff(value);
}

export function loadPublishedCanonicalizerNodeRowHeadroomM447() {
