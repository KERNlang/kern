...
import { runKernFrontendEvolvedHintsCheck } from './check-kern-frontend-evolved-hints.mjs';
import { runKernFrontendGenericPropertyAdmissionCheck } from './check-kern-frontend-generic-property-admission.mjs';
import { runKernFrontendGenericPropertyLoopCheck } from './check-kern-frontend-generic-property-loop.mjs';
import { runKernFrontendGenericPropertyStyleThemeDiagnosticsCheck } from './check-kern-frontend-generic-property-style-theme-diagnostics.mjs';
import { runKernFrontendGenericPropertyStyleThemeCheck } from './check-kern-frontend-generic-property-style-theme.mjs';
import { runKernFrontendGenericPropertyThemeRefsCheck } from './check-kern-frontend-generic-property-theme-refs.mjs';
import { runKernFrontendIndentationCheck } from './check-kern-frontend-indentation.mjs';
import { runKernFrontendKeywordHandlersCheck } from './check-kern-frontend-keyword-handlers.mjs';
...
import { runKernFrontendSuccessfulLineCompositionCheck } from './check-kern-frontend-successful-line-composition.mjs';
...
const result = {
  ...
  evolvedHints: runKernFrontendEvolvedHintsCheck(),
  genericPropertyAdmission: runKernFrontendGenericPropertyAdmissionCheck(),
  genericPropertyLoop: runKernFrontendGenericPropertyLoopCheck(),
  genericPropertyStyleTheme: runKernFrontendGenericPropertyStyleThemeCheck(),
  genericPropertyStyleThemeDiagnostics: runKernFrontendGenericPropertyStyleThemeDiagnosticsCheck(),
  genericPropertyThemeRefs: runKernFrontendGenericPropertyThemeRefsCheck(),
  indentation: runKernFrontendIndentationCheck(),
  keywordHandlers: runKernFrontendKeywordHandlersCheck(),
  ...
  successfulLineComposition: runKernFrontendSuccessfulLineCompositionCheck(),
  tokenizer: runKernFrontendTokenizerCheck(),
  whitespaceTrim: runKernFrontendWhitespaceTrimCheck(),
};

console.log(`KERN frontend successful-line composition regression wall: ${JSON.stringify(result)}`);
