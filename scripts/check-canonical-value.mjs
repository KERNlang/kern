...
export function runCanonicalValueCheck() {
  for (const sourcePath of sourceFiles(sourceRoot)) {
    ...
    if (readFileSync(sourcePath, 'utf8').includes('canonical-value')) {
  ...
  process.stdout.write(
    'Canonical value reader: PASS (INTERNAL; browser graph closed; ALPHA-NO-GO; no KIR v1, public export, runtime adoption, or probe replacement).\n',
  );
}
