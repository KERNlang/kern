...
Kern Review -- 206 rules, taint tracking, OWASP LLM01 coverage, and framework-aware review checks
...
Kern Review ships 206 AST-based rules across base correctness, security, framework, performance, test-quality, null-safety, dead-logic, concept, and taint-aware analysis layers.
