...
Kern Review -- 215 rules, taint tracking, OWASP LLM01 coverage, and framework-aware review checks
...
Kern Review ships 215 AST-based rules across base correctness, security, framework, performance, test-quality, null-safety, dead-logic, concept, and taint-aware analysis layers.
