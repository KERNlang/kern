...
const RULE_CONFIDENCE_BASELINE: Record<string, number> = {
  ...
  'context-created-in-component': 90,
  'context-default-assertion': 90,
  'controlled-input-nullish-value': 90,
  'cookie-hardening': 90,
  'crypto-iv-reuse': 92,
  'crypto-weak-kdf': 90,
  'dead-export': 90,
  ...
  'eval-use': 95,
  'fastapi-implicit-request-globals': 92,
  'focused-test-only': 92,
  'hardcoded-secret': 95,
  'helmet-missing': 90,
  'html-string-target-blank-noopener': 90,
  'hook-length-dependency': 90,
  'iframe-dynamic-src-missing-sandbox': 90,
  'interval-state-setter-needs-functional-update': 90,
  ...
  'empty-catch': 80,
  'encoding-bypass': 75,
  'effect-fetch-missing-cancel-guard': 82,
  ...
  'handler-size': 75,
  'imperative-handle-missing-deps': 82,
  ...
  'memo-comparator-ignores-function-prop': 82,
  ...
  'react-hook-form-context-fallback': 82,
  'prototype-pollution': 80,
  'rag-poisoning': 70,
  'redirect-non-3xx-status': 88,
  'regex-dos': 78,
  'route-handler-catch-status-undefined': 82,
  'route-handler-json-content-type-missing': 82,
  'route-handler-json-unguarded': 82,
  'electron-localhost-wildcard-cors': 82,
  'electron-open-external-unvalidated': 82,
  'inline-json-script-escape': 88,
  'react-native-pressable-missing-a11y': 82,
  'session-local-storage-outside-helper': 82,
  'sensitive-route-public-cache': 82,
  'sensitive-console-log': 82,
  'state-mutation': 80,
