...
import {
  stylesToTailwind, colorToTw, countTokens, serializeIR, camelKey,
  escapeJsString, buildTailwindProfile, applyTailwindTokenRules,
  getProps, getStyles, getPseudoStyles, getThemeRefs,
  buildDiagnostics, accountNode, expandStyles,
} from '@kernlang/core';
...
import type { PlannedFile } from './structure-vue.js';
...
function _buildTailwindVueSFC(root: IRNode, config?: ResolvedKernConfig): { code: string; sourceMap: SourceMapEntry[] } {
