 ...
 *
 *  Body-statement nodes (`expression-v1`, `assign`, `return`, `throw`, `do`, `capability`, `continue`, `break`, `while`, `for`, `with`,
 ...
 *
 *  Rules:
 *    - `assign`, `return`, `throw`, `do`, `capability`, `continue`, `break`, `while`, `for`, `with` are rejected outside
 *      a native-body scope.
