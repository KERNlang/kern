...
describe('Structural Detectors', () => {
  describe('structural-model', () => {
    it('detects TypeORM entity', () => {
      const results = detect(getDetector('structural-model'), `
        @Entity()
        export class User {
          @Column() id: string;
          @Column() email: string;
  ...
  describe('structural-repository', () => {
    it('detects repository class', () => {
      const results = detect(getDetector('structural-repository'), `
  ...
  describe('structural-dependency', () => {
    it('detects constructor injection', () => {
      const results = detect(getDetector('structural-dependency'), `
        class AuthService {
  ...
  describe('structural-cache', () => {
    it('detects Redis operations', () => {
      const results = detect(getDetector('structural-cache'), `
  ...
  describe('structural-conditional', () => {
    it('detects feature flag usage', () => {
      const results = detect(getDetector('structural-conditional'), `
  ...
  describe('structural-select', () => {
    it('detects HTML select', () => {
      const results = detect(getDetector('structural-select'), `
