...
export const SHELL_EXEC_PATTERN =
  /\b(exec|execSync|execFile|execFileSync|spawn|spawnSync|child_process)\b/;

export const NETWORK_PATTERN =
  /\b(fetch|http\.request|https\.request|axios|got\.get|got\.post)\b/;
...
export const PY_SHELL_EXEC_PATTERN =
  /\b(subprocess|os\.system|os\.popen|execSync|execFile|spawn|spawnSync)\b/;

export const PY_NETWORK_PATTERN =
  /\b(requests\.|httpx\.|aiohttp\.|urllib\.|fetch|http\.request)\b/;
