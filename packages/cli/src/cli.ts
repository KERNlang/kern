...
import { parseWithDiagnostics, decompile, resolveConfig, VALID_TARGETS, VALID_STRUCTURES, generateCoreNode, isCoreNode, detectVersionsFromPackageJson, scanProject, generateConfigSource, formatScanSummary, registerTemplate, isTemplateNode, expandTemplateNode, clearTemplates, detectTemplates, COMMON_TEMPLATES, collectCoverageGaps, writeCoverageGaps, NODE_TYPES } from '@kernlang/core';
import type { ResolvedKernConfig, KernTarget, KernStructure, KernConfig, IRNode, ParseDiagnostic } from '@kernlang/core';
...
function surfaceParseDiagnostics(diagnostics: ParseDiagnostic[], file?: string): void {
...
function parseAndSurface(source: string, file?: string): IRNode {
